  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="inline-flex items-center text-[11px] font-medium uppercase tracking-[0.14em] text-ivory-muted">
          Frais estimés
        ...
        <div className="relative flex shrink-0 gap-1 rounded-full border border-line p-0.5">
          <span
            aria-hidden="true"
          ...
          {[
            ...
            <button
              ...
              className={[
                'relative z-10 min-h-9 rounded-full px-3 py-1.5 text-xs tracking-[0.1em] transition-colors duration-300',
                mode === opt.id
                  ? 'text-gold'
        ...
        {mode === 'percent' ? (
          <div className="space-y-3">
            <div className="flex items-baseline justify-between gap-3">
              <label htmlFor="fees-percent" className="text-sm text-ivory-muted">
                Courtage / stockage
              </label>
              <span className="font-display text-xl text-gold tabular-nums transition-all duration-300">
          ...
          <div className="field-line space-y-2">
            <label htmlFor="fees-fixed" className="text-sm text-ivory-muted">
              Montant fixe
            </label>
            <div className="relative">
              <input
                ...
                className="w-full min-w-0 border-b border-transparent bg-transparent py-2 pr-14 font-display text-2xl text-ivory outline-none"
              />
